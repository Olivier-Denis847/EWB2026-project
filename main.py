...
PLAY_BUTTON = button.Button(HIGHLIGHT_COLOR, (3*WIDTH // 4 + 50, HEIGHT // 4 + 40), 24, PLAY_ICON_PATH)
...
START_BUTTON = pygame.Rect(WIDTH // 2 - 100, HEIGHT // 3 + 25, 200, 50)
ROOM_CODE_BOX = textbox.TextBox(WIDTH // 2 - 100, HEIGHT * 3 // 4 - 40, 200, 40, font_main)
...
while running:
    ...
    if STATE == 'main':
        ...
        back_text = font_main.render('Next', True, DARK_COLOR)
        ...
        screen.blit(second_text, (WIDTH // 2 - second_text.get_width() // 2, HEIGHT // 2))
        room_text = font_main.render('Join Room', True, FONT_COLOR)
        screen.blit(room_text, (WIDTH // 2 - room_text.get_width() // 2, HEIGHT // 2 + 70))
